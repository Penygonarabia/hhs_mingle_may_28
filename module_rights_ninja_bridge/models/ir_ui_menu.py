...
docstring in module_rights/models/dashboard_rights_menu.py). This is the
copy that actually runs in production; keep it byte-for-byte in sync with
module_rights/models/ir_ui_menu.py.
"""
...
class IrUiMenu(models.Model):
    ...
    def _dr_restricted_menu_ids(self):
        ...
        #
        # NB: this copy is the one that actually runs (see module docstring —
        # this bridge module shadows module_rights/models/ir_ui_menu.py in
        # the MRO). Keep both copies byte-for-byte in sync.
