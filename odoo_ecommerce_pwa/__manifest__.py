...
PWA
Progressive Web Application
Odoo Website Progressive Web Application
Progressive Web Application in Odoo Website
Odoo PWA
PWA in Odoo Website
Progressive Web App""",
  "live_test_url"        :  "http://odoodemo.webkul.com/?module=odoo_ecommerce_pwa&lifetime=60&custom_url=/",
  ...
  "assets"               :  {
                              "web.assets_backend" :  [
                                '/odoo_ecommerce_pwa/static/src/css/res_config.css'
                              ],
                              "web.assets_frontend" : [
                                '/odoo_ecommerce_pwa/static/src/css/pwa_offline.css',
                                '/odoo_ecommerce_pwa/static/src/js/website_pwa.js',
                              ],
                            },
