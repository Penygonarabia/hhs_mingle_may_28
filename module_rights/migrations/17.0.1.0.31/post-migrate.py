...
Covers 17.0.1.0.31: added the "Copy Rights From…" wizard
(dashboard.rights.copy.wizard) and its button on both Rights Setup and
Module Rights Setup. No data changes; this purge is only the routine
