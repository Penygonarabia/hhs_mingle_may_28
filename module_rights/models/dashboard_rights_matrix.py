...
class DashboardRightsMatrix(models.TransientModel):
    ...
    def action_view_rights_summary(self):
        ...
        return {
            ...
            "view_mode": "tree,form",
            "views": [
                [self.env.ref("module_rights.view_dashboard_rights_summary_list").id, "tree"],
                [self.env.ref("module_rights.view_dashboard_rights_form").id, "form"],
            ],
            "domain": [("user_id", "=", self.user_id.id)],
            "search_view_id": [self.env.ref("module_rights.view_dashboard_rights_search").id, "search"],
