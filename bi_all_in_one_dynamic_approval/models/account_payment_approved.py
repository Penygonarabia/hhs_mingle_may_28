...
class AccountPaymentApproval(models.Model):
    _name = "account.payment.approved"
    _description = "Account Payment Approval details"
    ...
    payment_approval_id = fields.Many2one('approval.approval', string='Payment Approval')
