...
class ResConfigSettings(models.TransientModel):
    ...
    #     default=False,
    #     config_parameter="setu_inventory_count_management.extended_ic_module_in_registry"
    # )
    ...
    #     action_values = self.sudo().sudo().env.ref('setu_inventory_count_management.actions_setu_inventory_count_configuration').sudo().read()[0]
