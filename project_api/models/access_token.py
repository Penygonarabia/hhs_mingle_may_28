...
class APIAccessToken(models.Model):
    ...
    token_expiry_date = fields.Datetime(string="Token Expiry Date")
    ...
    #         _logger.warning("Token expiry date is not set for token ID: %s", self.id)
    #         return True  # Treat tokens without an expiry date as expired.
    #     expiry_date = fields.Datetime.from_string(self.token_expiry_date)
