...
patch(WebClient.prototype, {
    setup() {
        ...
        onMounted(() => {
            ...
            // Ensure that tooltips are only initialized after the DOM is fully ready
            const tooltipElements = document.querySelectorAll('[data-tooltip]'); // Add your selector for tooltip elements
            tooltipElements.forEach((el) => {
                if (el instanceof HTMLElement) {
                    useTooltip(el); // Initialize tooltip for each valid element
                }
            });
        });
