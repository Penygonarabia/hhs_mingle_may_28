...
class EmployeeShift(models.Model):
    ...
    name = fields.Char(string='Day', tracking=True, translate=True)
    shift_type_id = fields.Many2one('shift.type', string='Shift Type', tracking=True)
    time_from = fields.Float(string='From Time', tracking=True)
    time_to = fields.Float(string='To Time', tracking=True)
