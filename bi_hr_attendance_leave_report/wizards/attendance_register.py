...
class EmployeeAttendanceRegister(models.TransientModel):
    ...
    def print_excel(self):
        data = {
            ...
            'model': 'employee.attendance.register'

        }
        return self.env.ref('bi_hr_attendance_leave_report.action_report_attendance_register_xlsx').report_action(self,
                                                                                                                  data=data)
...
class EmployeeLeaveRegister(models.TransientModel):
    ...
    def print_excel(self):
        ...
        data = {
            'form_data': self.read()[0],
            'model': 'employee.leave.register'

        }
        return self.env.ref(
            'bi_hr_attendance_leave_report.action_report_attendance__leave_register_xlsx').report_action(self,
                                                                                                         data=data)