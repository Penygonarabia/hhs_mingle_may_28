...
# from . import vi_product_catalog
# from . import hr_attendance
# from . import attendance_review_wizard
from . import res_config_settings
from . import sales_target
from . import vi_monthly_sales_target
from . import product
from . import fsm_loyalty_audit
