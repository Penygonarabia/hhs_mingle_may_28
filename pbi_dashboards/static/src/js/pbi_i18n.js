...
const LABELS = {
  ...
  // pbi_drill_menu.js — the right-click / long-press level picker
  "Drill down to": "التعمق إلى",
  "Break down by": "التقسيم حسب",
  "Drilled levels": "المستويات المحددة",
  "Release filter": "إلغاء الفلتر",
  "Open": "فتح",
  "Next": "التالي",
  "Cancel": "إلغاء",
  "Close": "إغلاق",
  "Right-click": "انقر بالزر الأيمن",
  "Long-press": "اضغط مطولاً",
  "a bar to drill one level": "على عمود للتعمق مستوى واحد",
  "a bar for every other level": "على عمود لكل المستويات الأخرى",
  "Tap": "انقر",
  "Click": "انقر",
