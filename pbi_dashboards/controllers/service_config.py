...
# (see service_main.py's _period_months), so "This Year" divides by
...
class MeasureConfig:
    ...
    # client-side value format (see service_main.py's _value_format:
    # *_hours renders H:MM, *_pct renders "96.59%"), so it should still
    # end in the right suffix even though no such column exists.
    agg: str = "sum"
