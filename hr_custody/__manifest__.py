...
###################################################################################
{
    ...
    'depends': ['hr', 'mail', 'hr_employee_updation', 'product', 'account','om_hr_payroll', 'hr_exit_process', 'base_accounting_kit'],
    'data': [
        ...
        'reports/hr_custody_xlsx.xml',
        'wizard/custoody_template_report.xml',
        'wizard/views_employee_custody_report.xml'
    ],
