...
class PromotionDetailedReport(models.AbstractModel):
    _name = 'report.hhs_loyalty_management.promo_detailed_template'
    _description = 'Promotion Detailed Report Abstract Model'
