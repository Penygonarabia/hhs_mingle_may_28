...
class ContractProfromaInvoiceReport(models.AbstractModel):
    _name = 'report.machine_repair_management.proforma_invoice_report'
    _description = 'Contract Proforma Invoice Report'
