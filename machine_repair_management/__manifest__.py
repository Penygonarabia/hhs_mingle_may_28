...
workshop machine repair
    ...
    #         'views/portal_jobcards_template.xml',
    ...
    #         "views/views_ir_sequence.xml",
    #         "views/views_res_config_settings.xml",
    #         "views/project_task_type_views.xml",
    #         'views/payment_receipt_views.xml',
    #         "views/service_cost_view.xml",
    #         "wizard/views_job_card_report_wizard.xml",
    #         "report/report_machine_repair_support_xlsx.xml",
    #         "report/machine_repair_document.xml",
    #         "report/report_receipt_payment.xml",
    #         "report/job_card_template_preformatted.xml",
    #         "report/report_job_card_inbuilt_preformated.xml",
    #         "report/job_card_template_report.xml",
    ...
    #         "views/views_work_center_group.xml",
    #         "views/views_stock_warehouse.xml",
    #         "datas/inbuilt_print_job_receipts.xml",
    #         "report/sale_order_quotation_report.xml",
    #         "datas/invoice_schedule_data.xml",
    #         "datas/data_mail.xml",
    #         "wizard/views_job_card_wizard.xml",
    #         "views/res_district_views.xml",
    #         "views/service_sale_order_views.xml",
    #         "report/report_service_sale_order_report.xml",
    #         "views/service_warranty_views.xml",
    #         "views/views_project.xml",
    #         "report/report_ac_unit_service_receipt_report.xml",
    #         "views/capacity_service_request_views.xml",
    #         "report/service_job_card_report.xml",
    #         "views/views_cancellation_reason.xml",
    #         "report/report_cash_receipt_format.xml",
    #         "wizard/wizard_negative_stock_notification.xml",
    #         "wizard/cancelled_reason_wizard_views.xml",
    #         "report/sale_order_amc_quotation_report.xml",
    #         'datas/mail_template.xml',
    #         # 'datas/data_job_card_show.xml',
    #         # "views/views_project_project.xml",
    ...
    "data": [
        ...
        "report/preventive_job_card_report.xml",
        "report/preventive_job_card_template.xml",
        # Mail Templates (after all reports exist)
        "datas/mail_template.xml",
        "datas/data_mail.xml",
        # Views
        "views/feedback.xml",
        ...
        "views/capacity_service_request_views.xml",
        "views/views_cancellation_reason.xml",
        "views/views_on_hold_spare_parts_reason.xml",
        ...
        "wizard/wizard_negative_stock_notification.xml",
        "wizard/cancelled_reason_wizard_views.xml",
        "wizard/onhold_spareparts_wizard_views.xml",
        "wizard/views_service_request_report.xml",
        "views/crm_contract_type.xml",
    ...
    "assets": {
        "web.assets_backend": [
            "machine_repair_management/static/src/css/custom_readonly.css",
            "machine_repair_management/static/src/js/task_accordion.js",
            "machine_repair_management/static/src/css/conditional_underline.css",
            "machine_repair_management/static/src/js/phone_popup.js",
            "machine_repair_management/static/src/js/phone_popup_list_controller.js",
            "machine_repair_management/static/src/xml/templates.xml",
            # 'machine_repair_management/static/src/js/job_state_cancel_popup.js',
            "machine_repair_management/static/src/js/job_state_cancel.js",
            "machine_repair_management/static/src/js/form_controller_no_properties.js",
            "machine_repair_management/static/src/js/signature_auto_open.js",
            ...
            # 'machine_repair_management/static/src/js/stock_warning.js',
